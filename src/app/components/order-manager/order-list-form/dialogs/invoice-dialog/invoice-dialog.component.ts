...
export class InvoiceDialogComponent implements OnInit {
  ...
  showInvoice() {
    ...
    console.log(sendManager)
    this.url = `${environment.apiUrl}/api/FastReport/ShowReportInvoice?Id=${this.order.order.sub_num}&EndTime=${this.selectedDaysCount}&Manager=${sendManager}&Date=${this.nowFormatted}`
  }
